...
setwd("/Users/donglinlu/Desktop/CC1/10.GO")       #设置工作目录
rt=read.table("HMMR_prioritized_6_9_10_pooled_sigDiff.txt", header=T, sep="\t", check.names=F)       #读取差异分析的结果文件
...
ontology.col=c("#3498db", "#2ecc71", "#e67e22")
